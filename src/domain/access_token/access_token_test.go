...
func TestGetNewAccessToken(t *testing.T) {
	...
	assert.EqualValues(t, "", at.AccessToken, "new access token should noy have defined access token id")

	assert.EqualValues(t, 0, at.UserId, "New access token should noy have an associated user id")
}
